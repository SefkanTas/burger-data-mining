...
Nous allons donc nous interessé à chacun de ces mesures de données dans les difféerents produits pour tous les restaurants.
...
En moyenne, la quantité suffisante de sodium necessaire et suffisante est de 1 500 mg soit 1.5 g et la dose qui est nocive est 2 300 mg soit 2.3 g. Nous allons donc voir quels produits dépassent la quantité suffisante (<1,5g et >2,3g )

```{r sodium , echo=FALSE}
ggplot(burger, aes(x=Item,y=Sodium)) + geom_point() + annotate(geom = "rect",xmin = -Inf,xmax = Inf,ymin = 1.5,ymax = 2.3,alpha= 0.2 ,fill="red")
```
